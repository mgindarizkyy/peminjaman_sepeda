        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-warning float-left">Data Peminjam</h6>
                    <a href="input_peminjam.php" class="btn btn-warning float-right">Tambah Peminjam</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-info" href="edit_peminjam.php?id=<?php echo $data['id_peminjam']; ?>">Edit</a>
